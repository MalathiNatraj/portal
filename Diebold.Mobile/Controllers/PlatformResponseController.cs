...
namespace Diebold.WebApp.Controllers
{
    public class PlatformResponseController : BaseAsyncController
    {
        ...
        protected static ILog logg = LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        ...
        [AllowAnonymous]
        [HttpPost]
        public ActionResult GetCardHolderInformation()
        {
            try
            {
                logger.Debug("Get card holder information response received from platform.");
                PrepareResponseObject("GetCardHolderInformation");
                return Json("Received request successfully.");
            }
            catch (Exception ex)
            {
        ...
        [AllowAnonymous]
        [HttpPost]
        public ActionResult GetUserCodeInformation()
        {
            try
            {
                logger.Debug("GetUserCodeInformation response received from platform.");
                PrepareResponseObject("GetUserCodeInformation");
                return Json("Received request successfully.");
            }
            catch (Exception ex)
            {
