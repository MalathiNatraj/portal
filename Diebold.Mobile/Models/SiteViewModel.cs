...
namespace DieboldMobile.Models
{
    public class SiteViewModel : BaseMappeableViewModel<Site>
    {
        ...
        [RegularExpression(@"^[a-zA-Z\s]*$", ErrorMessage = "Please enter a valid Site Name")]
        [JqGridColumnLayout(Width = 150)]
        ...
        [RegularExpression(@"^[a-zA-Z\s]*$", ErrorMessage = "Please enter a valid Parent Association")]
        public string ParentAssociation { get; set; }

        [DisplayName("Diebold Name: (*)")]
        [ScaffoldColumn(false)]
        [Required(ErrorMessage = "Diebold Name is required")]
        [RegularExpression(@"^[a-zA-Z\s]*$", ErrorMessage = "Please enter a valid Diebold Name")]
        ...
        [RegularExpression(@"^[a-zA-Z\s]*$", ErrorMessage = "Please enter a valid City")]
        public string City { get; set; }

        [DisplayName("State: (*)")]
        [ScaffoldColumn(false)]
        [Required(ErrorMessage = "State is required")]
        [RegularExpression(@"^[a-zA-Z\s]*$", ErrorMessage = "Please enter a valid State")]
        ...
        [RegularExpression(@"^[a-zA-Z\s]*$", ErrorMessage = "Please enter a valid County")]
        public string County { get; set; }

        [DisplayName("Country: (*)")]
        [ScaffoldColumn(false)]
        [Required(ErrorMessage = "Country is required")]
        [RegularExpression(@"^[a-zA-Z\s]*$", ErrorMessage = "Please enter a valid Country")]
        public string Country { get; set; }

        [DisplayName("CCMF: (*)")]
        [ScaffoldColumn(false)]
        [Required(ErrorMessage = "CCMF Status is required")]
        [RegularExpression(@"^[a-zA-Z0-9\s]*$", ErrorMessage = "Please enter a valid CCMF Status")]
