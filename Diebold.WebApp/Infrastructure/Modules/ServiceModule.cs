    ...
    public class ServiceModule : NinjectModule
    {
        public override void Load()
        {
            ...
            */
            ...
            Bind<IDeviceMediaService>().To<DeviceMediaService>().InRequestScope();
            ...
            Bind<IEventDescriptionFiltersService>().To<EventDescriptionFiltersService>().InRequestScope();
            Bind<IFireAlarmService>().To<FireAlarmService>().InRequestScope();
            Bind<ISiteDocumentService>().To<SiteDocumentService>().InRequestScope();
            Bind<IImpersonateService>().To<ImpersonateService>().InRequestScope();
            Bind<ICompanyInventoryService>().To<CompanyInventoryService>().InRequestScope();
            Bind<ISiteInventoryService>().To<SiteInventoryService>().InRequestScope();
            ...
            Bind<ISiteAccNumberService>().To<SiteAccNumberService>().InRequestScope();
