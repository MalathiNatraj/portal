...
namespace Diebold.WebApp.Infrastructure.Authentication
{
    ...
    /*
    public class RoleActionAuthorizeAttribute : FilterAttribute
    {
        public Diebold.Domain.Entities.Action Action { get; set; }
    }
    */

    //[AttributeUsage(AttributeTargets.Class | AttributeTargets.Method, Inherited = true, AllowMultiple = true)]
    //public class RoleActionAuthorize : System.Web.Mvc.AuthorizeAttribute
    public class RoleActionAuthorize : IAuthorizationFilter
    {
        ...
        */ 
        ...
        public RoleActionAuthorize(IUserService userService, Domain.Entities.Action roleAction)
            : base()
        {
