...
namespace Diebold.WebApp.Areas.PlataformFake.Controllers
{
    ...
    public class ApiCallController : Controller
    {
        ...
        {
            return Json(new { unassignedSlots = new[] { "AA:BB:CC:11", "AA:BB:CC:22", "AA:BB:CC:33", "AA:BB:CC:44", "AA:BB:CC:55", "AA:BB:CC:66", 
                                                        "AA:BB:CC:77", "AA:BB:CC:88", "AA:BB:CC:99"} }, JsonRequestBehavior.AllowGet);
        }
