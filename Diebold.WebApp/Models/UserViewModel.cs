...
namespace Diebold.WebApp.Models
{
    public class UserViewModel : BaseMappeableViewModel<User>
    {
        ...
        [StringLength(32)]
        [Required]
        [RegularExpression(@"^[a-zA-Z0-9.!@#$%^&*()_+<>?/\\}{:'~`=;\""\-\[\]]+(( )+[a-zA-z0-9.!@#$%^&*()_+<>?/\\}{:'~`=;\""\-\[\]]+)*$", ErrorMessage = "Please enter a valid first name")]
        ...
        [StringLength(32)]
        [Required]
        [RegularExpression(@"^[a-zA-Z0-9.!@#$%^&*()_+<>?/\\}{:'~`=;\""\-\[\]]+(( )+[a-zA-z0-9.!@#$%^&*()_+<>?/\\}{:'~`=;\""\-\[\]]+)*$", ErrorMessage = "Please enter a valid last name")]
        ...
        [StringLength(50)]
        [Required]        
        [RegularExpression(@"^[a-zA-Z0-9.!@#$%^&*()_+<>?/\\}{:'~`=;\""\-\[\]]*$", ErrorMessage = "Please enter a valid username")]
        ...
        [StringLength(20)]
        [Required]
        [RegularExpression(@"^[a-zA-Z0-9.!@#$%^&*()_+<>?/\\}{:'~`=;\""\-\[\]]*$", ErrorMessage = "Please enter a valid phone number")]
        ...
        [RegularExpression(@"^[a-zA-Z0-9.!@#$%^&*()_+<>?/\\}{:'~`=;\""\-\[\]]*$", ErrorMessage = "Please enter a valid office phone number")]
        ...
        [StringLength(20)]
        [ScaffoldColumn(false)]
        [RegularExpression(@"^[a-zA-Z0-9.!@#$%^&*()_+<>?/\\}{:'~`=;\""\-\[\]]*$", ErrorMessage = "Please enter a valid mobile number")]
