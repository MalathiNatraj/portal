...
namespace DieboldMobile.Infrastructure.Authentication
{
    public class DieboldMembershipProvider : MembershipProvider
    {
        ...
        public virtual bool UserCanPerformAction(string userName, Diebold.Domain.Entities.Action action)
        {
            return _userService.UserCanPerformAction(userName, action);
        }

        //internal bool UserCanPerformAction(string userName, Diebold.Domain.Entities.Action action)
        //{
        //    throw new NotImplementedException();
        //}
    }
